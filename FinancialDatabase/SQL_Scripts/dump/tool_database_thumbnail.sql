...
CREATE TABLE `thumbnail` (
  `ThumbnailID` int unsigned NOT NULL AUTO_INCREMENT,
  `thumbnail` longblob NOT NULL,
  PRIMARY KEY (`ThumbnailID`),
  UNIQUE KEY `ThumbnailID_UNIQUE` (`ThumbnailID`)
) ENGINE=InnoDB AUTO_INCREMENT=15951 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
